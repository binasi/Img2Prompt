...
## 更新摘要
**变更内容**
- 新增高还原度模式配置选项，支持更精确的图像还原提示词生成
- 增强的提示词模板系统，新增动漫插画、建筑室内、美食摄影、人像摄影等专业领域模板
- 更新选项页面界面，增加高还原度模式开关控件
- 扩展专业领域定制化需求，支持更多专业场景的提示词生成
...
- USER_PROMPT_PRESETS 预设场景的使用与自定义方法，覆盖 general、photo、cg、design、assets3d、product、ui、anime、architecture、food、portrait 等模板及其适用场景与配置要点
...
- 场景与要点
  ...
  - anime：动漫插画场景，包含角色设计、艺术风格、背景元素、色彩主题等详细分析
  - architecture：建筑室内设计，涵盖建筑风格、结构元素、材料色调、空间布局等技术分析
  - food：美食摄影，包含菜品构图、食材可见度、烹饪技法、器皿搭配、光影设置等专业要素
  - portrait：人像摄影，涵盖人物外观、姿态语言、服装造型、灯光布景、后期处理等全方位分析
- 使用方式
...
- [options.html:590-603](file://options.html#L590-L603)
...
- 预设优先，模板补充
  ...
  - 利用新增的专业领域模板（动漫插画、建筑室内、美食摄影、人像摄影）提升专业场景的生成质量
- 高还原度模式应用
...
## 结论
通过 USER_PROMPT_PRESETS 的场景化模板、高还原度模式配置选项、自定义模板的灵活扩展、UI_STRINGS 与 SETTINGS_I18N 的双语支持，以及后台与内容脚本的协同，Img2Prompt 提供了强大的高级定制能力。新增的专业领域模板（动漫插画、建筑室内、美食摄影、人像摄影）和高还原度模式进一步增强了扩展的专业性和精确度。结合最佳实践与故障排查方法，用户可以按自身工作流高效地生成与复用高质量提示词，并在多语言环境下保持一致的使用体验。
