...
## 更新摘要
**变更内容**
- 新增了高还原度模式配置项（recreateMode）
- 简化了设置面板结构，移除了高级配置选项
- 更新了国际化支持的实现方式
- 移除了部分历史配置项（如 apiTimeout、requestTimeout 等）
- 优化了配置系统的整体架构
...
**章节来源**
- [config.js:26-27](file://config.js#L26-L27)
- [background.js:187-192](file://background.js#L187-L192)
...
**章节来源**
- [config.js:24-25](file://config.js#L24-L25)
- [config.js:31-43](file://config.js#L31-L43)

**章节来源**
- [config.js:24-28](file://config.js#L24-L28)
- [config.js:31-43](file://config.js#L31-L43)
...
Experience[使用体验<br/>悬浮按钮, 截屏功能, 语言, 高还原度模式]
...
| 高还原度模式标题 | 高还原度模式 | High-Fidelity Recreation Mode |
...
**章节来源**
- [config.js:148-249](file://config.js#L148-L249)
- [options.html:531-794](file://options.html#L531-L794)
...
- **易用性**: 直观的设置界面和丰富的预设模板
- **可靠性**: 完善的错误处理和故障排除机制
- **专业性**: 新增的高还原度模式满足专业用户需求

建议用户根据具体使用场景选择合适的配置，并定期评估和调整设置以获得最佳效果。

**更新** 本次更新反映了基础配置的重大变化，包括新增高还原度模式、简化设置面板结构、更新国际化支持实现方式等重要改进。