...
## 更新摘要
**变更内容**
- 智能预设处理逻辑重构：从 options.js 移至 background.js
- 增强的智能堆叠算法：支持场景预设与基础提示词的智能组合
- 优化的用户体验：预设选择的即时反馈和状态同步
- 完善的预设匹配机制：支持通用预设和场景预设的智能识别
...
**图表来源**
- [options.js:42-66](file://options.js#L42-L66)
